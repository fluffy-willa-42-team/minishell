...
/*   Updated: 2022/06/21 11:03:52 by awillems         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cmd_instr(int (**pipe_ptr)[2], int (*p_ptr)[2], int instr_index);
int	cmd_redirect(int (**pipe_ptr)[2], int (*p_ptr)[2], int instr_index);
int	cmd_separator(int (**pipe_ptr)[2], int (*p_ptr)[2]);
